...
# ----------------------------------------------------------------------------
_C.MODEL.PIXTRAL = CN()
_C.MODEL.PIXTRAL.action_type = C.ORIGINAL
_C.MODEL.PIXTRAL.original_action_dim = 4
_C.MODEL.PIXTRAL.horizon = 8
_C.MODEL.PIXTRAL.history = 1
_C.MODEL.PIXTRAL.pixtral_model_id = "mistralai/Pixtral-12B-2409"
_C.MODEL.PIXTRAL.use_lora = False
_C.MODEL.PIXTRAL.use_qlora = False  # if use_lora is False, then this does not matter
_C.MODEL.PIXTRAL.num_cam = 1
_C.MODEL.PIXTRAL.lora_config = "default"
_C.MODEL.PIXTRAL.lora_rank = 8
_C.MODEL.PIXTRAL.rgb_input = True
_C.MODEL.PIXTRAL.rgb_img_size = (84, 84)
_C.MODEL.PIXTRAL.add_vision_id = False
_C.MODEL.PIXTRAL.tiled_rgb_imgs = False
_C.MODEL.PIXTRAL.num_bins_actions = 1000
_C.MODEL.PIXTRAL.use_flash_attention_2 = False
_C.MODEL.PIXTRAL.action_mask_aug_per = 0.1
_C.MODEL.PIXTRAL.attention_dropout = 0.0
