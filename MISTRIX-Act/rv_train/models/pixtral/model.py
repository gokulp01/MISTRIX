...
from rv_train.pipelines.pixtral import (
    ActionCodecConfig,
    ActionTextCodec,
    LabelMaskConfig,
    LossLabelBuilder,
...
@dataclass
class PixtralRuntimeConfig:
    pixtral_model_id: str
    action_type: str
...
class PixtralPolicy(nn.Module):
    """Pixtral VLA policy with a modular encode/train/decode pipeline."""
    ...
    def __init__(
        ...
        self.runtime = PixtralRuntimeConfig(
            pixtral_model_id=pixtral_model_id,
        ...
        self.pixtral_model_id = self.runtime.pixtral_model_id
        ...
        self.model = self.load_pixtral_model(
            pixtral_model_id=self.runtime.pixtral_model_id,
        ...
        self.processor = self.load_pixtral_processor(
            pixtral_model_id=self.runtime.pixtral_model_id,
    ...
    def load_pixtral_model(
        ...
        return PixtralModelLoader.create_model(
            model_id=pixtral_model_id,
            use_lora=use_lora,
            use_qlora=use_qlora,
            lora_config=lora_config,
            lora_rank=lora_rank,
    ...
    @staticmethod
    def load_pixtral_processor(
        pixtral_model_id,
        min_pixel,
        max_pixel,
        padding_side,
    ):
        return PixtralModelLoader.create_processor(
            model_id=pixtral_model_id,
    ...
    def from_pretrained(self, path, is_trainable=True):
        PixtralModelLoader.restore_from_checkpoint(
            actor=self,
            path=path,
