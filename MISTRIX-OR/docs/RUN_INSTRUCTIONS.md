...
From the parent directory that contains `MISTRIX-OR/`, enter the repo first:
...
If you are already inside `MISTRIX-OR/`, skip `cd MISTRIX-OR`.

## 2) Optional Hugging Face Authentication

Needed for default backbone IDs (`mistralai/Pixtral-12B-2409`, `google/medasr`) when your account requires auth:
